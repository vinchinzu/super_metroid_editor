...
Each item PLM's `param` maps to a bit in `$7E:D870` (512 bits). Every item across the entire ROM must have a unique `param`. Vanilla uses 0x00–0x50; editor assigns from 0x51–0x1FF (431 slots).
