...
import com.supermetroid.editor.rom.RoomMatcher
...
fun main() {
    ...
    if (!romFile.exists()) {
        println("ROM not found at $testRomPath")
        return
    }
    ...
    if (!foundByIndex) {
        println("  No match found by index field")
    }
